...
exports.industryCategories = exports.industries = void 0;
exports.getIndustryBySlug = getIndustryBySlug;
exports.getIndustriesByCategory = getIndustriesByCategory;
exports.industries = [
    // ─── Trades ────────────────────────────────────────────────────────
    {
        slug: "builders",
        ...
        metaDescription: "GuardX helps builders collect more Google reviews automatically. Build trust with homeowners, rank higher in local search, and win more jobs with a five-star reputation.",
        h1: "Web Design, SEO & Review Generation for Builders",
        intro: "As a builder, your reputation is your business. Homeowners and commercial clients check Google reviews before choosing who to trust with their property. GuardX automates the review collection process, so every completed project has the chance to generate a five-star review that wins you more work.\n\nOur email and SMS system sends personalised review requests to your clients after every job, capturing their satisfaction while it is fresh. No awkward conversations, no chasing — just a steady stream of genuine reviews that grow your reputation.",
        challenges: "Builders often struggle to collect reviews because projects can last weeks or months, and asking for feedback feels uncomfortable after completing physical work. Many builders have hundreds of satisfied customers but only a handful of reviews. This gap between actual quality and online visibility costs real jobs, especially when competitors with more reviews appear higher in search results.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps construction companies build five-star Google reputations. Automated review requests that win client trust and generate more project enquiries.",
        h1: "Web Design, SEO & Review Generation for Construction Companies",
        intro: "Construction companies handle large-scale projects where trust and credibility are paramount. Clients making significant investments want to see proof that your company delivers. GuardX automates your Google review collection, ensuring your online reputation reflects the scale and quality of your work.\n\nOur system sends personalised review requests at project milestones or completion, making it easy for commercial and residential clients alike to share their experience. A growing review profile positions your company as the trusted choice for future projects.",
        challenges: "Construction companies face unique review challenges: projects are long-term, clients may be developers or businesses rather than individuals, and the review ask often falls through the cracks amid handovers and snag lists. Without a systematic approach, construction firms miss out on the social proof that drives new enquiries and tender opportunities.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps scaffolding companies collect more Google reviews. Build trust with contractors and homeowners, improve local visibility, and win more work.",
        h1: "Web Design, SEO & Review Generation for Scaffolders",
        intro: "Scaffolding companies work behind the scenes on many building projects, but your Google reviews are what make you visible to new clients. Whether you serve builders, homeowners, or commercial developers, GuardX automates review collection so your reputation grows with every job.\n\nOur email and SMS system sends personalised review requests to your clients after each project, ensuring the quality of your service is captured in five-star reviews that bring in new business.",
        challenges: "Scaffolders often work as subcontractors, making it harder to collect reviews directly from end clients. The nature of the work — temporary structures that get removed — means the scaffolding company can be forgotten once the project moves on. GuardX ensures your contribution is recognised with visible Google reviews.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps flooring shops and fitters collect more Google reviews automatically. Build trust, improve local rankings, and attract more customers.",
        h1: "Web Design, SEO & Review Generation for Flooring Shops",
        intro: "Flooring shops and installers rely on trust and visual proof of quality. Customers want to see that others have had a great experience before committing to a purchase and installation. GuardX automates your Google review collection, turning every happy customer into a visible endorsement of your work.\n\nOur system sends personalised review requests after installation or purchase, ensuring customers share their satisfaction when it is highest. A strong review profile drives showroom visits and installation bookings.",
        challenges: "Flooring businesses often miss review opportunities because the purchase-to-installation timeline can stretch over weeks. By the time the floor is laid, the initial excitement has faded and customers forget to leave feedback. GuardX captures that satisfaction at the right moment with timely, automated requests.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps carpet cleaning businesses collect more Google reviews. Automated requests that build trust, improve rankings, and fill your diary with bookings.",
        h1: "Web Design, SEO & Review Generation for Carpet Cleaners",
        intro: "Carpet cleaning is a service where customers see immediate, visible results — which makes it perfect for generating enthusiastic Google reviews. GuardX automates the process, sending personalised review requests right after each clean when customers are most impressed with the transformation.\n\nOur email and SMS system handles everything, turning that 'wow moment' into a five-star Google review that attracts new customers and keeps your diary full.",
        challenges: "Carpet cleaners often work alone or in small teams, making it difficult to manage review requests alongside the physical demands of the job. Many customers are thrilled with the results but simply forget to leave a review. Without automation, this positive feedback is lost. GuardX captures it effortlessly.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps driveway companies build five-star Google reputations. Automated review requests that win homeowner trust and generate more project enquiries.",
        h1: "Web Design, SEO & Review Generation for Driveway Companies",
        intro: "Driveway installations are high-value projects where homeowners do extensive research before choosing a company. Your Google reviews are one of the first things they check. GuardX automates review collection so every completed driveway can generate a five-star review that wins you the next job.\n\nOur system sends personalised email and SMS requests after project completion, making it easy for satisfied homeowners to share their experience. A strong review profile means more enquiries, more quotes, and more projects.",
        challenges: "Driveway companies face a common trades challenge: the work speaks for itself, but busy homeowners rarely think to leave a review unless prompted. Projects are also seasonal, meaning review collection needs to be consistent during peak periods to sustain visibility year-round.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps roofing companies collect more Google reviews automatically. Build homeowner trust, rank higher in search, and win more roofing contracts.",
        h1: "Web Design, SEO & Review Generation for Roofers",
        intro: "Roofing is one of the trades where trust matters most — homeowners are inviting you to work on one of the most critical parts of their property. A strong Google review profile signals that you are reliable, skilled, and trustworthy. GuardX automates the review collection process so your reputation grows with every job.\n\nOur personalised email and SMS review requests are sent after every completed project, ensuring satisfied customers have an easy way to share their experience. More five-star reviews mean more visibility and more jobs.",
        challenges: "Roofers face particular trust challenges because the work is difficult for homeowners to inspect themselves. Customers rely heavily on reviews and recommendations when choosing a roofer. Yet many roofing companies have few reviews because asking feels awkward after completing a job. GuardX removes that friction entirely.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps plumbers collect more Google reviews automatically. Build trust, rank higher in local search, and get more callouts with a five-star reputation.",
        h1: "Web Design, SEO & Review Generation for Plumbers",
        intro: "Plumbing is an essential service where customers need to make fast decisions, often in emergencies. When someone searches for a plumber on Google, your reviews are the deciding factor. GuardX automates the review process so every completed job has the opportunity to generate a five-star review.\n\nOur system sends personalised email and SMS review requests immediately after each job, capturing customer satisfaction while it is fresh. The result: a growing Google profile that keeps your phone ringing.",
        challenges: "Plumbers handle multiple jobs daily, making manual review requests impractical. Emergency callouts mean customers are grateful in the moment but quickly move on. Without an automated system, this gratitude rarely translates into visible online reviews. GuardX ensures it does.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps electricians build five-star Google reputations automatically. More reviews mean more trust, higher rankings, and more work coming in.",
        h1: "Web Design, SEO & Review Generation for Electricians",
        intro: "Electricians handle critical work in homes and businesses, and customers want reassurance that they are hiring someone competent and trustworthy. Your Google reviews provide that reassurance. GuardX automates review collection so your online reputation grows alongside your business.\n\nOur email and SMS system sends personalised review requests after every job, from small domestic fixes to large commercial installations. A consistent flow of five-star reviews keeps you visible and trusted in local search.",
        challenges: "Electricians are busy professionals who complete multiple jobs per day. Finding time to ask for reviews is unrealistic, and many customers do not think to leave one unless prompted. This creates a gap between the quality of work delivered and the reviews visible online. GuardX closes that gap automatically.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps painters and decorators collect Google reviews automatically. Showcase your craftsmanship, build trust, and win more decorating contracts.",
        ...
        challenges: "Painters and decorators often work on projects that leave customers impressed but they rarely think to leave a review. The visual transformation is admired privately, but without prompting, it does not make its way onto Google. GuardX captures that satisfaction and turns it into visible social proof.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps cafes and coffee shops collect more Google reviews. Build a five-star reputation that attracts regulars and brings in new customers automatically.",
        h1: "Web Design, SEO & Review Generation for Cafes",
        intro: "Cafes thrive on footfall and loyalty, and Google reviews drive both. When someone new to the area searches for a cafe, your review profile is the first thing they see. GuardX automates the review collection process, turning your regular customers into visible online advocates.\n\nOur email and SMS system sends personalised review requests that encourage customers to share what they love about your cafe. A growing stream of genuine five-star reviews builds the reputation that keeps your tables full.",
        challenges: "Cafes have high customer volumes but low review conversion because the transaction is quick and informal. Customers enjoy their coffee and move on without thinking about leaving a review. The key is reaching them shortly after their visit with a simple, friendly prompt — which is exactly what GuardX does.",
    ...
    // ─── Automotive ────────────────────────────────────────────────────
    {
        ...
        metaDescription: "GuardX helps garages and auto repair shops collect more Google reviews. Build customer trust, rank higher in local search, and fill more service bays.",
        h1: "Web Design, SEO & Review Generation for Garages",
        intro: "Garages rely on trust — customers need to know their vehicle is in safe hands. Google reviews are the most visible way to demonstrate that trust. GuardX automates review collection so every satisfied customer has the chance to share their experience, building a reputation that drives more bookings.\n\nOur email and SMS system sends personalised review requests after every service, MOT, or repair. A consistent flow of five-star reviews strengthens your Google presence and keeps your bays busy.",
        challenges: "Garages handle multiple vehicles daily, and the focus is always on the next job. Asking for reviews at the counter feels rushed, and follow-up falls by the wayside. Meanwhile, customers who had a great experience simply drive away without leaving feedback. GuardX captures that positive experience automatically.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps mechanics and auto repair specialists collect more Google reviews. Build trust, improve local visibility, and attract more customers automatically.",
        h1: "Web Design, SEO & Review Generation for Mechanics",
        intro: "Finding a trustworthy mechanic is one of the most common local searches on Google. Your reviews are often the deciding factor for customers choosing between you and the garage down the road. GuardX automates review collection so your expertise and reliability are visible to everyone searching.\n\nOur system sends personalised email and SMS review requests after every repair, service, or MOT. The result: a growing Google profile that builds customer confidence and keeps your workshop fully booked.",
        challenges: "Mechanics are hands-on professionals who spend their day under vehicles, not on computers. Manual review requests are impractical, and customers who are pleased with a repair rarely think to go online and leave feedback. GuardX bridges this gap with automated, perfectly timed requests.",
    ...
    // ─── Home Services ─────────────────────────────────────────────────
    {
        ...
        metaDescription: "GuardX helps cleaning companies collect more Google reviews. Automated requests that build trust, improve rankings, and keep your schedule fully booked.",
        h1: "Web Design, SEO & Review Generation for Cleaning Companies",
        intro: "Cleaning companies operate in one of the most competitive local service markets. Customers have many options, and your Google reviews are often the tipping point that wins a booking. GuardX automates review collection so every clean can generate a five-star review that attracts more business.\n\nOur email and SMS system sends personalised review requests after every clean, whether it is a one-off deep clean or a regular domestic service. A growing review profile means more visibility, more trust, and a diary that stays full.",
        challenges: "Cleaning companies handle high volumes of repeat customers but rarely convert that loyalty into visible reviews. Staff turnover and the routine nature of the service mean review requests are easily forgotten. GuardX ensures that every satisfied client has the opportunity to share their experience.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps landscaping businesses collect more Google reviews. Showcase your outdoor projects, build trust, and attract more landscaping clients.",
        h1: "Web Design, SEO & Review Generation for Landscapers",
        intro: "Landscaping projects create stunning visual transformations that homeowners are proud to show off. GuardX helps you turn that pride into visible Google reviews by automating the review collection process. Every completed garden, patio, or outdoor space becomes an opportunity for a five-star review.\n\nOur system sends personalised email and SMS review requests after project completion, capturing customer delight when it is at its peak. These reviews build a reputation that attracts new clients and positions you as the go-to landscaper in your area.",
        challenges: "Landscapers create beautiful work that often gets shared on social media but rarely translates into Google reviews. The project-based nature of landscaping means each review opportunity is valuable, and missing it means waiting until the next project. GuardX ensures no opportunity is wasted.",
    ...
    },
    {
        ...
        metaDescription: "GuardX helps barbershops collect more Google reviews. Build a loyal client base, improve local visibility, and keep your barber chairs fully booked.",
        h1: "Web Design, SEO & Review Generation for Barbershops",
        intro: "Barbershops are community hubs where loyalty and reputation are everything. Your Google reviews are how new customers discover you and decide to give you a try. GuardX automates review collection so every haircut, shave, or grooming session has the potential to generate a five-star review.\n\nOur email and SMS system sends personalised review requests after each appointment, capturing the satisfaction of a fresh cut while it is still front of mind. A growing review profile attracts new walk-ins and keeps your regular clients coming back.",
        challenges: "Barbers operate in high-volume, fast-turnover environments where there is little time for administrative tasks. Clients are in and out quickly, and the opportunity to ask for a review passes in minutes. Many barbershops have loyal regulars who would happily leave reviews but are never asked. GuardX asks for you.",
...
function getIndustryBySlug(slug) {
    return exports.industries.find((i) => i.slug === slug);
}
function getIndustriesByCategory(category) {
    return exports.industries.filter((i) => i.category === category);
}
exports.industryCategories = [
    "Trades",
    "Home Services",
    "Property",
    "Automotive",
