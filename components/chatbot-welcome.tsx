      ...
      <div className="fixed bottom-6 right-6 z-50">
        {!isOpen && (
          <Button
            ...
            className="bg-primary text-black hover:bg-primary-dark rounded-full w-14 h-14 shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse border-2 border-primary"
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-[#2a2a2a]">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary font-medium">● Online now</p>
                </div>
              </div>
              <Button
                variant="ghost"
              ...
              <div className="p-4">
                ...
                <div className="space-y-2 mb-4">
                  {salesQuestions.map((item, index) => (
                    <div
                      key={`sales-${index}`}
                      className="border border-[#2a2a2a] rounded-lg hover:border-primary/50 transition-colors"
                    >
                      <Button
                        variant="ghost"
                        className="w-full justify-between text-left p-3 h-auto font-medium hover:bg-primary/10 text-white"
                      ...
                      {selectedQuestion === index && (
                        <div className="px-3 pb-3 border-t border-[#2a2a2a]/50">
                          ...
                          {item.nudge && (
                            <div className="text-xs text-primary font-medium italic mb-2">{item.nudge}</div>
                          )}
                        </div>
                      )}
                    </div>
                ...
                <div className="border-t border-[#2a2a2a] pt-4 mb-4">
                  <h4 className="text-sm font-semibold text-primary mb-3">Frequently Asked Questions</h4>
                  <div className="space-y-2">
                ...
                <div className="space-y-2 pt-3 border-t border-[#2a2a2a]">
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-[#2a2a2a] hover:bg-primary/10 hover:border-primary text-white transition-all duration-200 bg-transparent"
