...
const buttonVariants = (props?: { variant?: string; size?: string; className?: string }) => {
  ...
  switch (variant) {
    ...
    case "outline":
      ...
      break
    case "secondary":
      variantClasses = "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80"
      break
    case "ghost":
    ...
    case "link":
      ...
      break
    default:
      variantClasses = "bg-primary text-primary-foreground shadow-xs hover:bg-primary/90"
  }
