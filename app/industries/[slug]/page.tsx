...
const industryImages: Record<string, { src: string; alt: string }> = {
  builders: { src: "/images/industries/builder.jpg", alt: "Builder working on a residential construction site" },
  "construction-companies": { src: "/images/industries/construction-companies.jpg", alt: "Construction site with workers and steel framework" },
  scaffolders: { src: "/images/industries/scaffolding.jpg", alt: "Scaffolding erected on a residential building" },
  "flooring-shops": { src: "/images/industries/flooring.jpg", alt: "Flooring specialist installing hardwood flooring" },
  "carpet-cleaners": { src: "/images/industries/carpet-cleaners.jpg", alt: "Professional carpet cleaner at work" },
  "driveway-companies": { src: "/images/industries/driveway-companies.jpg", alt: "Driveway block paving installation" },
  roofers: { src: "/images/industries/roofers.jpg", alt: "Roofer replacing tiles on a residential roof" },
  plumbers: { src: "/images/industries/plumber.jpg", alt: "Plumber fixing pipes in a kitchen" },
  electricians: { src: "/images/industries/electrician.jpg", alt: "Electrician working on residential wiring" },
  "painters-and-decorators": { src: "/images/industries/painters-and-decorators.jpg", alt: "Painter and decorator painting a wall" },
  "estate-agents": { src: "/images/industries/estate-agents.jpg", alt: "Estate agent showing a property to buyers" },
  "letting-agents": { src: "/images/industries/letting-agents.jpg", alt: "Letting agent handing over house keys" },
  restaurants: { src: "/images/industries/restaurants.jpg", alt: "Modern restaurant interior with diners" },
  cafes: { src: "/images/industries/cafes.jpg", alt: "Cosy British cafe interior" },
  garages: { src: "/images/industries/garages.jpg", alt: "Professional car garage workshop" },
  mechanics: { src: "/images/industries/mechanics.jpg", alt: "Mechanic diagnosing an engine" },
  "cleaning-companies": { src: "/images/industries/cleaning-companies.jpg", alt: "Professional cleaning team at work" },
  landscapers: { src: "/images/industries/landscapers.jpg", alt: "Landscaper designing a garden" },
  "tree-surgeons": { src: "/images/industries/tree-surgeons.jpg", alt: "Tree surgeon working with climbing gear" },
  locksmiths: { src: "/images/industries/locksmiths.jpg", alt: "Locksmith working on a front door lock" },
  dentists: { src: "/images/industries/dentists.jpg", alt: "Modern dental surgery treatment room" },
  physios: { src: "/images/industries/physios.jpg", alt: "Physiotherapist treating a patient" },
  gyms: { src: "/images/industries/gyms.jpg", alt: "Modern gym interior with fitness equipment" },
  salons: { src: "/images/industries/salons.jpg", alt: "Hair and beauty salon interior" },
  barbers: { src: "/images/industries/barber.jpg", alt: "Barber giving a professional haircut" },
}
