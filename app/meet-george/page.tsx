...
export const metadata: Metadata = {
  ...
  description: "Meet George, a trained digital member of staff for your website. He answers customer questions, explains services, and captures enquiries 24/7.",
