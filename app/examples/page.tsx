...
const examples: ExampleCard[] = [
  ...
  },
  {
    ...
    subtitle: "Homepage example for a plumbing business.",
  ...
  },
  {
    ...
    subtitle: "Homepage example for an electrical contractor.",
    imageSrc: "/images/examples/electrician-card.jpg",
    href: "https://guardx-electrician.vercel.app/",
    icon: Zap,
    status: "live",
  },
  {
    title: "Builder Website",
    subtitle: "Homepage example for a building company.",
    imageSrc: "/images/examples/builder-card.jpg",
    href: "https://guardx-builder1.vercel.app/",
    icon: HardHat,
    status: "live",
  },
  {
    title: "Scaffolding Website",
    subtitle: "Homepage example for a scaffolding firm.",
    imageSrc: "/images/examples/scaffolding-card.jpg",
  ...
  },
  {
    ...
    subtitle: "Homepage example for driveways / landscaping.",
    imageSrc: "/images/examples/driveways-card.jpg",
    href: "https://guardx-driveways-and-landscaping.vercel.app/",
    icon: Shovel,
    status: "live",
  },
