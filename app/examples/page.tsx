...
const examples: ExampleCard[] = [
  ...
  { title: "Builder Website", subtitle: "Homepage example for a building company.", imageSrc: "/images/examples/builder-thumb.jpg", href: "https://guardx-builder1.vercel.app/", icon: HardHat, status: "live" },
  { title: "Scaffolding Website", subtitle: "Homepage example for a scaffolding firm.", imageSrc: "/images/examples/scaffolding-thumb.jpg", href: "https://highview-scaffolding.vercel.app/", icon: Wind, status: "live" },
  { title: "Driveways & Landscaping", subtitle: "Homepage example for driveways / landscaping.", imageSrc: "/images/examples/driveways-thumb.jpg", href: "https://guardx-driveways-and-landscaping.vercel.app/", icon: Shovel, status: "live" },
