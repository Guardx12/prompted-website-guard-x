...
export default function ReviewGenerationPage() {
 ...
 <AnimatedPageTitle text="GuardX" suffix="-- Stand Out on Google. Get Chosen More Often." className="mb-6" />
              <p className="text-xl text-[#94a3b8] mb-6 font-medium">The Google Visibility System for Local UK Businesses</p>
              ...
              <p className="text-2xl md:text-3xl text-[#cbd5e1] mb-6 font-semibold">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="#free-scorecard"
                  className="inline-block bg-blue-500 text-white hover:bg-blue-600 px-8 py-4 text-lg font-bold shadow-xl rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] text-center"
                >
                ...
                <a
                  ...
                  className="inline-block bg-white/10 text-white hover:bg-white/20 px-8 py-4 text-lg font-bold shadow-xl rounded-xl transition-all duration-300 transform hover:scale-105 border border-white/20 backdrop-blur-sm text-center"
                >
                  Book a Call
                </a>
              </div>
              <a
                href="/real-results"
                className="inline-block mt-4 text-[#94a3b8] hover:text-blue-400 transition-colors duration-200 text-base font-medium"
              >
      ...
      <section className="py-16 bg-[#111827]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 scroll-animate">
            ...
            <p className="text-xl text-[#94a3b8] max-w-4xl mx-auto leading-relaxed mb-8">
            ...
            <p className="text-xl text-[#94a3b8] max-w-4xl mx-auto leading-relaxed mb-4">
      ...
      <section className="py-16 bg-[#0a0e1a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">The Google Visibility System</h2>
          ...
          <div className="max-w-4xl mx-auto mb-12 scroll-animate">
            <h3 className="text-2xl font-bold text-white mb-6 text-center">We handle everything for you:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-blue-400 flex-shrink-0 mt-1" />
                <p className="text-[#94a3b8] text-lg">Automated email review requests</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-blue-400 flex-shrink-0 mt-1" />
                <p className="text-[#94a3b8] text-lg">Optional SMS review requests (98% open rate)</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-blue-400 flex-shrink-0 mt-1" />
                <p className="text-[#94a3b8] text-lg">CRM or BCC email integration</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-blue-400 flex-shrink-0 mt-1" />
                <p className="text-[#94a3b8] text-lg">Staff form for trades & in-person jobs</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-blue-400 flex-shrink-0 mt-1" />
                <p className="text-[#94a3b8] text-lg">Set up your Google, Facebook, Yell or any review links</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-blue-400 flex-shrink-0 mt-1" />
                <p className="text-[#94a3b8] text-lg">Fully done-for-you setup</p>
              </div>
            </div>
          </div>
      ...
      <section id="free-scorecard" className="py-16 bg-[#111827]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 scroll-animate">
            ...
            <div className="max-w-2xl mx-auto text-left mb-6">
              <ul className="space-y-3 text-lg text-[#94a3b8]">
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="bg-[#1e293b] border border-white/10 shadow-2xl scroll-animate">
                ...
                <form onSubmit={handleScorecardSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      name="email"
                      required
                      className="w-full px-4 py-3 border border-white/10 rounded-lg focus:border-blue-400 focus:outline-none bg-[#0a0e1a] text-white placeholder-[#64748b]"
                  ...
                  <div>
                    <label htmlFor="businessAddress" className="block text-sm font-bold text-white mb-2">
                      Business Address
                    </label>
                    <input
                      type="text"
                  ...
                  <button
                    ...
                    className="w-full bg-blue-500 text-white hover:bg-blue-600 px-8 py-4 text-lg font-bold shadow-xl rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
      ...
      <section className="py-16 bg-[#0a0e1a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12 scroll-animate">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center scroll-animate">
              ...
              <div className="w-20 h-20 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-4 text-3xl font-bold text-blue-400">
                1
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Connect your CRM or BCC email</h3>
              <p className="text-[#94a3b8]">Or use our simple staff form</p>
            </div>
            ...
            <div className="text-center scroll-animate">
              ...
              <p className="text-[#94a3b8]">Friendly email or SMS requests sent to your customers</p>
            </div>
            ...
            <div className="text-center scroll-animate">
              ...
              <p className="text-[#94a3b8]">Makes customers 4-5x more likely to leave a review</p>
            </div>
            ...
            <div className="text-center scroll-animate">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Your reviews and visibility grow month after month</h3>
              <p className="text-[#94a3b8]">More visibility. More trust. More customers.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12 scroll-animate">
            <a
              href="#free-scorecard"
              className="inline-block bg-blue-500 text-white hover:bg-blue-600 px-8 py-4 text-lg font-bold shadow-xl rounded-lg transition-all duration-300 transform hover:scale-105 text-center"
            >
              Get Your Free Scorecard
            </a>
            <a
      ...
      <section className="py-16 bg-[#111827]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-4 scroll-animate">Who We Help</h2>
          <p className="text-xl text-[#94a3b8] text-center mb-12 max-w-3xl mx-auto scroll-animate">
            GuardX works best for:
          </p>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                <Users className="w-12 h-12 text-primary mx-auto mb-3" />
                <h3 className="font-bold text-white text-sm">Trades & home services</h3>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-white text-sm">Flooring & carpet businesses</h3>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-white text-sm">Shops & retail</h3>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-white text-sm">Garages & MOT centres</h3>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-white text-sm">Gyms & fitness</h3>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                <Users className="w-12 h-12 text-primary mx-auto mb-3" />
                <h3 className="font-bold text-white text-sm">Salons & barbers</h3>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                <Shield className="w-12 h-12 text-primary mx-auto mb-3" />
                <h3 className="font-bold text-white text-sm">Pet services</h3>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-white/10 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all scroll-animate">
              <CardContent className="p-6 text-center">
                <Building2 className="w-12 h-12 text-primary mx-auto mb-3" />
                <h3 className="font-bold text-white text-sm">Local service businesses</h3>
              </CardContent>
            </Card>
          </div>

          <p className="text-xl text-[#94a3b8] text-center mt-12 max-w-3xl mx-auto scroll-animate font-semibold">
      ...
      <section className="py-16 bg-[#111827]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="bg-[#1e293b] border border-primary/20 shadow-lg hover:shadow-xl transition-all scroll-animate">
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-white">Holly Cox</p>
                    <p className="text-sm text-[#64748b]">Business Owner</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#1e293b] border border-primary/20 shadow-lg hover:shadow-xl transition-all scroll-animate">
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-white">Joseph Yossefi</p>
                    <p className="text-sm text-[#64748b]">Business Owner</p>
                  </div>
                </div>
              </CardContent>
      ...
      <section className="py-16 bg-[#0a0e1a]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center scroll-animate">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Stand Out on Google and Win More Customers?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#free-scorecard"
              className="inline-block bg-blue-500 text-white hover:bg-blue-600 px-8 py-4 text-lg font-bold shadow-xl rounded-lg transition-all duration-300 transform hover:scale-105 "
            >
              Get Your Free Scorecard
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-white/10 text-white hover:bg-white/20 px-8 py-4 text-lg font-bold shadow-xl rounded-xl transition-all duration-300 transform hover:scale-105 border border-white/20 backdrop-blur-sm"
            >
              Book a Call
            </a>
          </div>
