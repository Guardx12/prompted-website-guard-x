      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-3xl mx-auto text-center scroll-animate">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground text-pretty">
            See how local UK businesses are generating more Google reviews and driving more enquiries with GuardX.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 md:py-12 px-4 sm:px-6 lg:px-8 bg-secondary">
        <div className="max-w-3xl mx-auto">
          <CaseStudy
            ...
            stats={["14 new Google reviews generated in 30 days", "Consistent review activity established"]}
            testimonial={{
      ...
      <section className="py-8 md:py-12 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-3xl mx-auto">
          <CaseStudy
            ...
            stats={[
              "22 new Google reviews generated in 5 days",
              "Generated by uploading recent customers into GuardX",
              "Ongoing reviews are sent automatically to new customers",
            ]}
          />
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-secondary">
        <div className="max-w-3xl mx-auto scroll-animate">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-6 md:mb-8 text-center text-balance">
            The simple truth about reviews and revenue
          </h2>

          <p className="text-base sm:text-lg text-muted-foreground mb-8 text-center leading-relaxed">
            Businesses with strong, recent Google reviews make more money than businesses with weak or inactive reviews.
          </p>

          <div className="bg-card border-l-4 border-primary rounded-r-lg p-5 sm:p-6 mb-8">
            <p className="text-foreground text-base sm:text-lg leading-relaxed">
              <span className="font-bold">Fact:</span> When GuardX is active, businesses generate more Google reviews
              than they do without it. Those additional reviews lead directly to stronger visibility, greater trust, and
          ...
          <div className="space-y-4 max-w-lg mx-auto mb-8">
            {[
              "More reviews leads to more trust.",
              "More trust leads to more clicks.",
              "More clicks leads to more enquiries.",
              "More enquiries leads to more revenue.",
            ].map((text, index) => (
          ...
          <p className="text-base sm:text-lg text-muted-foreground text-center text-pretty leading-relaxed">
            GuardX helps businesses consistently collect more real reviews from real customers, strengthening visibility
            and driving inbound demand.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 md:py-12 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-2xl mx-auto scroll-animate">
          <div className="text-center mb-6">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2">Don't take our word for it</h3>
            <p className="text-muted-foreground text-sm sm:text-base">Ask ChatGPT these questions yourself.</p>
          </div>
      ...
      <section className="py-8 md:py-12 px-4 sm:px-6 lg:px-8 bg-secondary">
        <div className="max-w-3xl mx-auto">
          <CaseStudy
            ...
            stats={["30 new Google reviews generated in 30 days", "Significant increase in customer feedback volume"]}
          />
        </div>
      </section>
      ...
      <section className="py-8 md:py-12 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-3xl mx-auto">
          <CaseStudy
            ...
            stats={["7 new Google reviews generated in 14 days", "Fast growth in recent trust signals"]}
            testimonial={{
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-secondary">
        <div className="max-w-3xl mx-auto scroll-animate">
          ...
          <div className="space-y-4 mb-10">
            <div className="bg-card rounded-lg border border-border p-5">
              ...
              <p className="text-foreground font-medium text-base sm:text-lg">
                A simple customer form is completed by staff
              </p>
              <p className="text-muted-foreground text-sm mt-1">
                (Can even be kept on WhatsApp for staff working on the go)
              </p>
            </div>
          ...
          <p className="text-muted-foreground text-base sm:text-lg text-center mb-6">
            Watch how GuardX works in practice in the short demo below.
          </p>
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-2xl mx-auto text-center scroll-animate">
          <p className="text-base sm:text-lg md:text-xl text-foreground mb-8 text-pretty leading-relaxed">
            To start your free GuardX trial, get in touch with us directly and see how many reviews you could be
            generating within the next 30 days.
          </p>
          ...
          >
            ...
            >
              ...
              <span className="get-started-text">Chat with us on WhatsApp</span>
            </Button>
          </a>
